...
//  FlickrPhotoGallery
//
//  Created by Ruchin Singhal on 28/02/22.
//
...
extension PhotoGalleryViewC: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    getPhotoGalleryTableCell(forIndexPath: indexPath)
  }
  ...
  private func getPhotoGalleryTableCell(forIndexPath indexPath: IndexPath) -> PhotoGalleryTableCell {
    let photoGalleryTableCell = tblViewPhotoGallery.dequeueReusableCell(withIdentifier: PhotoGalleryTableCell
                                                                              .identifier(), for: indexPath) as! PhotoGalleryTableCell
    photoGalleryTableCell.configureCell(withPhotoGalleryItem: photoGalleryViewModel.photoGallery.photos.photo[indexPath.row], forIndexPath: indexPath)
    return photoGalleryTableCell
  }
}
